    ...
    <?php $footer_bg = (isset($close_footer_wrapper) && $close_footer_wrapper) ? 'bg-transparent' : 'bg-gradient-to-br from-blue-900 to-[#1952E1]'; ?>
    <footer class="<?php echo $footer_bg; ?> text-blue-200 pt-10 pb-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    <p class="text-xs text-blue-200 leading-relaxed max-w-sm mb-6">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-xs font-medium">
                        ...
                        <li><a href="./#professionals" class="hover:text-white transition-colors">Verified Talent</a></li>
                    </ul>
                </div>

                <div>
                    <h4 class="text-sm font-bold text-white uppercase tracking-wider mb-4">Community</h4>
                    <ul class="space-y-2.5 text-xs font-medium">
                        <li><a href="signup?role=client" class="hover:text-white transition-colors">Request Service</a></li>
                        <li><a href="signup?role=provider" class="hover:text-white transition-colors">Become a Professional</a></li>
            ...
            <div class="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-blue-300">
...
<?php if (isset($close_footer_wrapper) && $close_footer_wrapper): ?>
</div>
<?php endif; ?>
</body>
</html>
