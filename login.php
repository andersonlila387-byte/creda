...
// Active session verification & automatic role-based redirect
...
<head>
    ...
    <title>Log In - Scriptly Verified Marketplace</title>
    
    <!-- Primary SEO Meta Tags -->
    <meta name="title" content="Log In - Scriptly Verified Marketplace">
    <meta name="description" content="Log in to your Scriptly user account to manage projects, milestone escrows, chat in real-time, or access assessment tests.">
...
<body class="bg-brand-bg text-brand-dark font-sans antialiased selection:bg-blue-200 selection:text-blue-900">
    ...
    <div class="min-h-screen grid grid-cols-1 lg:grid-cols-12 overflow-hidden">
        ...
        <aside class="lg:col-span-5 hidden lg:flex flex-col justify-between text-white p-8 xl:p-10 relative overflow-hidden bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=1200');">
            ...
            <div class="relative z-10 max-w-sm space-y-5">
                ...
                <h2 class="font-serif text-3xl font-bold tracking-tight text-white leading-tight">
                    Manage contracts, track milestones, collaborate in real-time.
                </h2>
                <blockquote class="bg-white/10 backdrop-blur-md rounded-[3px] p-4 border border-white/15 text-xs leading-relaxed text-gray-200">
                    "The real-time messaging and direct collaboration make communicating with clients effortless. Milestone funds land straight into my wallet."
                    <footer class="mt-2 text-[11px] font-bold text-[#ffda79]">— Verified Professional Pro</footer>
                </blockquote>
            </div>
            ...
            <div class="relative z-10 pt-4 border-t border-white/15 flex items-center justify-between text-xs text-gray-400 font-medium">
                <div class="flex items-center gap-2">
                    ...
                    <span>Live Messaging Active</span>
                </div>
                <span>PCI-Compliant Escrow</span>
            </div>
        </aside>
        ...
        <main class="lg:col-span-7 flex flex-col justify-between p-6 sm:p-10 bg-white overflow-y-auto">
            ...
            <div class="max-w-sm w-full mx-auto my-auto space-y-5">
                ...
                <!-- Form Header -->
                <div>
                    <h1 class="font-serif text-2xl sm:text-3xl font-bold text-brand-dark tracking-tight">Log in to your account</h1>
                    <p class="text-xs text-gray-500 mt-1 leading-relaxed">Enter your credentials to access your user workspace.</p>
                </div>
                ...
                <div class="relative flex items-center justify-center my-2">
                    ...
                    <span class="bg-white px-3 text-[10px] font-extrabold text-gray-400 uppercase tracking-widest absolute">Or login with email</span>
                </div>
                ...
                <!-- Compact Form with Input Icons & Password Eye Toggle -->
                <form id="login-form" class="space-y-4" novalidate>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1">
                            <label for="password" class="block text-[11px] font-bold uppercase tracking-wider text-gray-700">Password</label>
                            <a href="forgot-password" class="text-[11px] text-blue-600 font-bold hover:underline">Forgot password?</a>
                        </div>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                            </span>
                            <input type="password" id="password" name="password" autocomplete="current-password" required placeholder="Enter password" class="w-full pl-10 pr-10 py-2.5 rounded-[3px] border border-gray-300 text-xs focus:outline-none focus:border-blue-600 font-medium transition-colors">
                    ...
                    <div class="flex items-center gap-2 pt-1">
                        <input type="checkbox" id="remember_me" name="remember_me" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <label for="remember_me" class="text-[11px] text-gray-600 font-medium">Remember me on this device</label>
                    </div>
                ...
                <div class="pt-4 border-t border-gray-100 text-center text-xs text-gray-500 font-medium">
                    Don't have a Scriptly account? <a href="signup" class="text-blue-600 font-bold hover:underline ml-0.5">Sign up for free →</a>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Interactive Eye Password Toggle Handler
            ...
            function showAlert(type, message) {
                ...
                customAlert.scrollIntoView({ behavior: 'smooth', block: 'nearest' });
            }
            ...
            loginForm.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    if (data.success) {
                        ...
                        setTimeout(() => {
                            const redirect = data.redirect || 'app/index.php';
